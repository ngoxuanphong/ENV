...
class Sprites:
    def __init__(self) -> None:
        self.background = Image.open(IMG_PATH+"backGroundBlack.jpg").resize(BG_SIZE).convert("RGBA")
        self.cards = []
        for value in card_values:
            self.cards.append(Image.open(IMG_PATH+f"{value}-Heart.png").convert("RGBA"))
