    ...
    def __init__(self) -> None:
        ...
        for name in card_names:
            if name != "background.png":
                self.cards[name.split(".png")[0]] = Image.open(IMG_PATH+name).resize((100, 130)).convert("RGBA")
sprites = Sprites()


class Params:
    def __init__(self) -> None:
        self.card_order = ["apples", "cheese", "bread", "chicken", "pepper", "mead", "silk", "crossbow", "2-apples", "2-cheese", "2-bread", "2-chicken", "3-apples", "3-cheese", "3-bread"]
...
def get_state_image(state=None):
    ...
    for p in range(4):
        ...
        draw_outlined_text(draw, text_1, params.font28, (s_+430-bbox[2], 20), (0, 0, 0), 1)
        bbox = draw.textbbox((0, 0), text_2, params.font28)
        draw_outlined_text(draw, text_2, params.font28, (s_+317-bbox[2], 210), (0, 0, 0), 1)
        bbox = draw.textbbox((0, 0), text_3, params.font28)
        draw_outlined_text(draw, text_3, params.font28, (s_+317-bbox[2], 260), (0, 0, 0), 1)
        bbox = draw.textbbox((0, 0), text_4, params.font28)
        draw_outlined_text(draw, text_4, params.font28, (s_+317-bbox[2], 310), (0, 0, 0), 1)
        ...
        for i in range(4):
            ...
            draw_outlined_text(draw, text, params.font28, (s_+3+110*i, 70), (255, 255, 255), 1)
        ...
        if p != 0:
            ...
            for i in range(15):
                ...
                draw_outlined_text(draw, text, params.font28, (s_0+110*i+55-bbox[2], 600+35*(p-1)), (255, 255, 255), 1)
            ...
            for i in range(4):
                text = str(temp[i])
                draw_outlined_text(draw, text, params.font28, (s_+3+110*i, 170), (255, 255, 255), 1)
    ...
    for k in range(3):
        ...
        for i in range(15):
            ...
            text = str(inf_1[i])
            bbox = draw.textbbox((0, 0), text, params.font28)
            draw_outlined_text(draw, text, params.font28, (s_0+110*i+55-bbox[2], 775+35*k), (255, 255, 255), 1)

    temp = state[367:382].astype(int)
    for i in range(15):
        text = str(temp[i])
        draw_outlined_text(draw, text, params.font28, (s_0+110*i-30, 702), (255, 255, 255), 1)

    temp = state[382:397].astype(int)
    for i in range(15):
        text = str(temp[i])
        bbox = draw.textbbox((0, 0), text, params.font28)
        draw_outlined_text(draw, text, params.font28, (s_0+110*i+50-bbox[2]//2-30, 710), (255, 255, 255), 1)

    temp = state[397:412].astype(int)
    for i in range(15):
        text = str(temp[i])
        bbox = draw.textbbox((0, 0), text, params.font28)
        draw_outlined_text(draw, text, params.font28, (s_0+110*i+100-bbox[2]-30, 718), (255, 255, 255), 1)
    ...
    text = str(phase)
    bbox = draw.textbbox((0, 0), text, params.font28)
    draw_outlined_text(draw, text, params.font28, (1050-bbox[2]//2, 450), (0, 0, 0), 1)
    return bg


action_annotations = ['bỏ thẻ apple', 'bỏ thẻ cheese', 'bỏ thẻ bread', 'bỏ thẻ chicken', 'bỏ thẻ peper', 'bỏ thẻ mead', 'bỏ thẻ silk', 'bỏ thẻ crossbow', 'bỏ thẻ green_apple', 'bỏ thẻ gouda_cheese', 'bỏ thẻ rye_bread', 'bỏ thẻ royal_rooster', 'bỏ thẻ golden_apple', 'bỏ thẻ bleu_cheese', 'bỏ thẻ pump_bread', 'Không bỏ thẻ nữa', 'Lấy thẻ chồng bài rút', 'Lấy thẻ chồng bài lật trái', 'Lấy thẻ chồng bài lật phải', 'Trả thẻ vào chồng bài lật trái', 'Trả thẻ vào chồng bài lật phải', 'bỏ thẻ apple vào túi', 'bỏ thẻ cheese vào túi', 'bỏ thẻ bread vào túi', 'bỏ thẻ chicken vào túi', 'bỏ thẻ peper vào túi', 'bỏ thẻ mead vào túi', 'bỏ thẻ silk vào túi', 'bỏ thẻ crossbow vào túi', 'bỏ thẻ green_apple vào túi', 'bỏ thẻ gouda_cheese vào túi', 'bỏ thẻ rye_bread vào túi', 'bỏ thẻ royal_rooster vào túi', 'bỏ thẻ golden_apple vào túi', 'bỏ thẻ bleu_cheese vào túi', 'bỏ thẻ pump_bread vào túi', 'Không bỏ thẻ vào túi nữa', 'Khai báo hàng là apple', 'Khai báo hàng là cheese', 'Khai báo hàng là bread', 'Khai báo hàng là chicken', 'Kiểm tra người đầu tiên cạnh mình', 'Kiểm tra người thứ 2 cạnh mình', 'Kiểm tra người thứ 3 cạnh mình', 'Không hối lộ coin nữa', 'Hối lộ thêm 1 coin', 'hối lộ thẻ apple done', 'hối lộ thẻ cheese done', 'hối lộ thẻ bread done', 'hối lộ thẻ chicken done', 'hối lộ thẻ peper done', 'hối lộ thẻ mead done', 'hối lộ thẻ silk done', 'hối lộ thẻ crossbow done', 'hối lộ thẻ green_apple done', 'hối lộ thẻ gouda_cheese done', 'hối lộ thẻ rye_bread done', 'hối lộ thẻ royal_rooster done', 'hối lộ thẻ golden_apple done', 'hối lộ thẻ bleu_cheese done', 'hối lộ thẻ pump_bread done', 'Không hối lộ thẻ done nữa', 'hối lộ thẻ apple trong túi', 'hối lộ thẻ cheese trong túi', 'hối lộ thẻ bread trong túi', 'hối lộ thẻ chicken trong túi', 'hối lộ thẻ peper trong túi', 'hối lộ thẻ mead trong túi', 'hối lộ thẻ silk trong túi', 'hối lộ thẻ crossbow trong túi', 'hối lộ thẻ green_apple trong túi', 'hối lộ thẻ gouda_cheese trong túi', 'hối lộ thẻ rye_bread trong túi', 'hối lộ thẻ royal_rooster trong túi', 'hối lộ thẻ golden_apple trong túi', 'hối lộ thẻ bleu_cheese trong túi', 'hối lộ thẻ pump_bread trong túi', 'Không hối lộ thẻ trong túi nữa', 'Kiểm tra hàng', 'Cho qua', 'Bỏ thẻ tịch thu vào bên trái', 'Bỏ thẻ tịch thu vào bên phải']
...
def get_main_player_state(env_components: Env_components, list_agent, list_data, action=None):
    ...
    while _env.system_check_end(env_components.env) and env_components.count_turn < 1000:
