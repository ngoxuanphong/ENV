...
class Sprites:
    def __init__(self) -> None:
        ...
        for value in card_values[-4:]:
            self.cards.append(Image.open(IMG_PATH+f"{value}down.jpg").resize(CARD_SIZE))
...
def get_state_image(state=None):
    ...
    arr_player_card_coordinate = np.array([[[250, 670], [310, 670], [370, 670], [430, 670], [490, 670], [550, 670], [610, 670], [670, 670], [730, 670], [790, 670], [850, 670], [910, 670], [370, 570], [430, 570], [490, 570], [550, 570], [610, 570], [670, 570], [730, 570]],
                                [[1080, 20], [1080, 80], [1080, 140], [1080, 200], [1080, 260], [1080, 320], [1080, 380], [1080, 440], [1080, 500], [1080, 560], [1080, 620], [1080, 680], [980, 140], [980, 200], [980, 260], [980, 320], [980, 380], [980, 440], [980, 500]],
                                [[250, 30], [310, 30], [370, 30], [430, 30], [490, 30], [550, 30], [610, 30], [670, 30], [730, 30], [790, 30], [850, 30], [910, 30], [370, 130], [430, 130], [490, 130], [550, 130], [610, 130], [670, 130], [730, 130]],
                                [[30, 20], [30, 80], [30, 140], [30, 200], [30, 260], [30, 320], [30, 380], [30, 440], [30, 500], [30, 560], [30, 620], [30, 680], [130, 140], [130, 200], [130, 260], [130,  320], [130, 380], [130, 440], [130, 500]]])

    arr_count_card_coor = [[[270, 770],[330, 770],[390, 770],[450, 770],[510, 770],[570, 770],[630, 770],[690, 770],[750, 770],[810, 770],[870, 770],[930, 770]],
                        [[1180, 40],[1180, 100],[1180, 160],[1180, 220],[1180, 280],[1180, 340],[1180, 400],[1180, 460],[1180, 520],[1180, 580],[1180, 640],[1180, 700]],
                        [[270, 20],[330, 20],[390, 20],[450, 20],[510, 20],[570, 20],[630, 20],[690, 20],[750, 20],[810, 20],[870, 20],[930, 20]],
                        [[15, 40],[15, 100],[15, 160],[15, 220],[15, 280],[15, 340],[15, 400],[15, 460],[15, 520],[15, 580],[15, 640],[15, 700]]]
    for id in range(4):
        player_in4 = state[20*id:20*(id+1)]
        background = draw_card_player(player_in4, background, id, arr_player_card_coordinate, arr_count_card_coor, draw)
...
def draw_card_on_board(state, background):
    board_card = np.array([[[370, 300], [430, 300], [490, 300], [550, 300], [610, 300], [670, 300]],
                            [[370, 400], [430, 400], [490, 400], [550, 400], [610, 400], [670, 400]]])
    card_board = state[80:92] > 0
    for i in range(12):
        if card_board[i]:
            draw_cards(background, np.array([i]), board_card[i//6][i%6][0], board_card[i//6][i%6][1], rotate=0)

    return background

def draw_card_player(player_in4, background, player_id, arr_player_card_coordinate, arr_count_card_coor, draw):
    card_player = player_in4[1:]
    #draw normal_card
    for i in range(19):
        if i < 15:
            if card_player[i] > 0:
                draw_cards(background, np.array([i]), arr_player_card_coordinate[player_id][i][0], arr_player_card_coordinate[player_id][i][1], rotate=player_id)
                if i < 12:
            ...
            if card_player[i] > 0:
                ...
                draw_cards(background, np.array([i+4]), arr_player_card_coordinate[player_id][i][0], arr_player_card_coordinate[player_id][i][1], rotate=player_id)
    return background
...
def draw_other(state, draw, background, myFont):
    ...
    if phase == 5:
        ...
        background.paste(sprites.robber, (robber_coor[player_robbed][0], robber_coor[player_robbed][1]))
        ...
        card_give_coor = np.array([[280, 720],[340, 720],[400, 720],[460, 720],[520, 720],[580, 720],[640, 720],[700, 720],[760, 720],[820, 720],[880, 720],[940, 720]])
        draw.text(card_give_coor[card_give],f"G",(255,255,255), font= myFont)

    elif phase == 7:
        card_buy_in_turn = state[92:104] > 0
        card_buy_coor = np.array([[280, 720],[340, 720],[400, 720],[460, 720],[520, 720],[580, 720],[640, 720],[700, 720],[760, 720],[820, 720],[880, 720],[940, 720]])
